...
def webhook():
    print("Mensaje recibido:", request.form.get("Body"))
    print("Usuario ID:", request.form.get("From"))
    
    resp = MessagingResponse()
    resp.message("✅ Bot activo, mensaje recibido")
    print("Respuesta enviada:", "✅ Bot activo, mensaje recibido")
    return str(resp)
